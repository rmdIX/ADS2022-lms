package by.it.group251052.hassan.lesson02;
...
public class Lesson2Test {
    ...
    Package:            by.it.group251052.hassan (тут ваша фамилия)
    ...
    */
    ...
    public void C_GreedyKnapsack() throws Exception {
        ...
        File f=new File(root+ "by/it/group251052/hassan/lesson02/greedyKnapsack.txt");
