...
public class Lesson12Test {
    ...
    public void A() throws Exception {
        HashMap<Vertex, Float> map = TaskA.getRoutes("by/it/group151051/artem_lakatun/lesson12/graphA.txt", "A");
    ...
    public void B() throws Exception {
        HashMap<Vertex, Float> map = TaskB.getRoutes("by/it/group151051/artem_lakatun/lesson12/graphB.txt", "A");
    ...
    public void C() throws Exception {
        float len = TaskC.getLen("by/it/group151051/artem_lakatun/lesson12/graphC.txt");
