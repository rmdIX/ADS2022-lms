package by.it.group151051.krupovich.lesson10;
import java.util.*;
...
public class TaskA<E> implements NavigableSet<E>
{
    ...
    public boolean add(E e)
    {
        ...
        {
            if (this.value.hashCode() < e.hashCode()) return this.right.add(e);
            if (this.value.hashCode() > e.hashCode()) return this.left.add(e);
        }
    ...
    public TaskA<E> deleteNode(TaskA<E> root, E key)
    {
        ...
        while (curr.value != null && !curr.value.equals(key))
        {
            ...
            if (curr.value.hashCode() > key.hashCode()) curr = curr.left;
        ...
        if (curr.left.value == null && curr.right.value == null)
        {
            ...
            {
                if (parent.left.value == curr.value) parent.left.value = null;
                else parent.right.value = null;
            }
            else root.value = null;
        ...
        else
        {
            ...
            else
            {
                ...
                if (curr.value != root.value)
                {
                    if (curr.value == parent.left.value) parent.left = child;
