package by.it.group151051.nebolsin.lesson05;
...
public class Lesson5Test {
    ...
    public void A() throws Exception {
        ...
        InputStream stream = new FileInputStream(root + "by/it/group151051/nebolsin/lesson05/dataA.txt");
    ...
    public void B() throws Exception {
        String root = System.getProperty("user.dir") + "/Prog/src/";
        InputStream stream = new FileInputStream(root + "by/it/group151051/nebolsin/lesson05/dataB.txt");
