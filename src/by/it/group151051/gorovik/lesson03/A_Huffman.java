package by.it.group151051.gorovik.lesson03;
...
public class A_Huffman {
    ...
    String encode(File file) throws FileNotFoundException {
        ...
        String sb = s.chars().mapToObj(cha->codes.getOrDefault((char)cha,"")).collect(Collectors.joining());
        return sb;
        //01001100100111
    }
    //!!!!!!!!!!!!!!!!!!!!!!!!!     КОНЕЦ ЗАДАЧИ     !!!!!!!!!!!!!!!!!!!!!!!!!
