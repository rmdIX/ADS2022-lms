package by.it.group251051.korneliuk.lesson03;
...
public class A_Huffman {
    ...
    String encode(File file) throws FileNotFoundException {
        ...
        while (mapIterator.hasNext()) {
            Map.Entry<Character, Integer> temp = mapIterator.next();
            priorityQueue.add(new LeafNode(temp.getValue(),temp.getKey()));
        }
